...
class Learning:
    ...
    def readFile(self):
        train = open("fulldata/trainwords.txt", 'r+').read().splitlines()
    ...
    def findPrior(self):
        ...
        np.savetxt("hmmprior_3.txt", self.prior)
    ...
    def findTrans(self):
        ...
        np.savetxt("hmmtrans_3.txt", self.trans)
    ...
    def findEmit(self):
        ...
        np.savetxt("hmmemit_3.txt", self.emit)
